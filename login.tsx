  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#121212', padding: 20 }}>
      ...
      <TextInput
        ...
        style={{ backgroundColor: '#1E1E1E', color: 'white', padding: 12, borderRadius: 8, width: '80%', marginBottom: 10 }}
      />
      <TextInput
      ...
      <TouchableOpacity
        onPress={handleLogin}
        style={{ backgroundColor: '#FFD700', padding: 12, borderRadius: 8, width: '80%', alignItems: 'center', marginBottom: 10 }}
      >
