...
const styles = {
  input: { backgroundColor: '#1E1E1E', color: 'white', padding: 12, borderRadius: 8, width: '80%', marginBottom: 10 },
  button: { backgroundColor: '#FFD700', padding: 12, borderRadius: 8, width: '80%', alignItems: 'center', marginBottom: 10 },
};
